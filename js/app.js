  ...
  return `
    <section class="stock-risk-panel">
      ...
      <div class="stock-risk-grid">
        <div class="stock-risk-metric" data-tooltip="Roční volatilita za poslední 3 roky. Počítá se jako směrodatná odchylka výnosů a annualizuje se. U fondů ukazuje kolísání hodnoty fondu."><div class="stock-risk-label"><span>Volatilita 3Y</span><span class="stock-risk-help" data-tooltip="Roční volatilita za poslední 3 roky. Počítá se jako směrodatná odchylka výnosů a annualizuje se. U fondů ukazuje kolísání hodnoty fondu." aria-label="Vysvětlení metriky Volatilita 3Y">?</span></div><strong id="${prefix}-risk-vol-3y">—</strong></div>
