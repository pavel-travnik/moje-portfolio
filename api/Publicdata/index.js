...
module.exports = async function (context, req) {
  ...
  if (!config) { context.res = jsonResponse(400, { error: 'Neplatný typ dat.' }); return; }
  if (!id || id.length > MAX_ID_LENGTH || !config.idPattern.test(id)) { context.res = jsonResponse(400, { error: 'Neplatný identifikátor.' }); return; }
